# -*- coding: cp936 -*-
# origin :http://python.jobbole.com/87812/
...
class Schelling:
    ...
    def plot(self, title, file_name):
        fig, ax = plt.subplots()
        # Èç¹ûÒª½øÐÐ³¬¹ý 7 ÖÖÑÕÉ«µÄ·ÂÕæ£¬ÄãÓ¦¸ÃÏàÓ¦µØ½øÐÐÉèÖÃ
...
# width 50，height 50(count:2500 houses),0.2 (Empty house pro),0.3(Similarity threshold)
...
schelling_2.plot('Schelling Model with 2 colors: Final State with Similarity Threshold 40%', 'schelling_2_40_final.png')
schelling_3.plot('Schelling Model with 2 colors: Final State with Similarity Threshold 50%', 'schelling_2_50_final.png')
schelling_4.plot('Schelling Model with 2 colors: Final State with Similarity Threshold 60%', 'schelling_2_60_final.png')
